...
def _build_training_parameters(raw: dict[str, Any], *, model_name: str | None = None) -> TrainingParameters:
    ...
    return TrainingParameters(
        ...
        topograph_enabled=bool(raw.get('topograph_enabled', False)),
        topograph_loss_weight=float(raw.get('topograph_loss_weight', 0.1)),
        topograph_debug_viz=bool(raw.get('topograph_debug_viz', False)),
        topograph_num_processes=max(1, int(raw.get('topograph_num_processes', 1))),
        topograph_use_c=bool(raw.get('topograph_use_c', False)),
