...
from logic_analyzer.application.structural_analysis import AnalyzeSequentialStructure
...
def run_gui(initial_path: str | Path | None = None) -> int:
    ...
    from logic_analyzer.presentation.qt.ui_strings import load_ui_strings
