...
def connect_settings_panel_signals(panel: Any) -> None:
    ...
    _connect_emitters(
        (
            ...
            panel.augmentation_multiplier_spinbox.valueChanged,
            ...
            panel.random_patch_size_check_box.toggled,
            panel.random_patch_min_x_size.valueChanged,
            panel.random_patch_min_y_size.valueChanged,
            panel.random_patch_max_x_size.valueChanged,
            panel.random_patch_max_y_size.valueChanged,
    ...
    _connect_noarg(panel.reset_defaults_button.clicked, panel._request_reset_defaults)
