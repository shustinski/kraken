...
def build_extraction_tab(self) -> QWidget:
    ...
    self.algorithm_backend_combo = QComboBox()
    self.algorithm_backend_combo.addItem("SEM auto", "sem")
    self.algorithm_backend_combo.addItem("Legacy", "legacy")
    self.profile_form.addRow("Recognition engine", self.algorithm_backend_combo)
    self.algorithm_backend_label_widget = self.profile_form.labelForField(self.algorithm_backend_combo)
    self.result_shape_combo = QComboBox()
    self.result_shape_combo.addItem("Polygon", "polygon")
    self.result_shape_combo.addItem("Box", "box")
    self.profile_form.addRow("Result shape", self.result_shape_combo)
    self.result_shape_label_widget = self.profile_form.labelForField(self.result_shape_combo)
    self.sem_noise_combo = QComboBox()
    self.sem_noise_combo.addItem("Balanced", "medium")
    self.sem_noise_combo.addItem("Clean image", "low")
    self.sem_noise_combo.addItem("Noisy image", "high")
    self.profile_form.addRow("SEM preset", self.sem_noise_combo)
    self.sem_noise_label_widget = self.profile_form.labelForField(self.sem_noise_combo)
    self.advanced_extraction_checkbox = QCheckBox("Advanced parameters")
    self.profile_form.addRow(self.advanced_extraction_checkbox)
    ...
    self.algorithm_backend_combo.currentIndexChanged.connect(self._on_extraction_settings_changed)
    self.result_shape_combo.currentIndexChanged.connect(self._on_extraction_settings_changed)
    self.sem_noise_combo.currentIndexChanged.connect(self._on_extraction_settings_changed)
