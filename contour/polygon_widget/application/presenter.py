...
from .model import PolygonWidgetApplicationModel
from .view import PolygonWidgetMainView


class PolygonWidgetPresenter:
    def __init__(self, *, model: PolygonWidgetApplicationModel, view: PolygonWidgetMainView) -> None:
        self.model = model
        self.view = view
        self._bind_view()
