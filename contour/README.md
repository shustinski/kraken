...
python -m polygon_widget                 # as a module
```
...
[`examples/polygon_widget_integration.py`](examples/polygon_widget_integration.py).
...
```powershell
ruff check polygon_widget tests examples
ruff format --check polygon_widget tests examples
mypy polygon_widget
