...
entrypoint = project_root / "Validation_gradient_widget_lite" / "debug" / "main.py"
runtime_hook = project_root / "hooks" / "rth_set_workdir.py"
icon_path = project_root / "_internal" / "icon.ico"
...
hiddenimports = [
    "Validation_gradient_widget_lite",
    "Validation_gradient_widget_lite.debug.main",
]
