...
В Hub права серверных проектов и роль Server Admin меняются в панели
администрирования сервера. Консоль `kraken-admin` эту панель не заменяет: она
готовит сервер, первого администратора и токены агентов.
