...
from lib.update_checker import UpdateClientConfig, UpdateInfo
from webui.services.broadcast_notifications import get_broadcast_notification_store
from webui.services.training_session import TrainingSessionService
import webui.services.training_session as training_session_module
...
class TestWebuiQtParityApis(TestCase):
    ...
    def test_upload_root_cleanup_removes_stale_children(self):
        from webui.views import _webui_upload_root
