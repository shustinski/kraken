...
from contour.vision.contour_extraction.hierarchy import build_hierarchy_from_mask
from contour.vision.contour_extraction.sem_filled_mask import (
    FilledMaskSegmentationConfig,
    extract_filled_mask,
)
from contour.vision.integration import contour_output_to_polygons, run_contour_filled_mask
from contour.vision.preprocessing import PreprocessConfig
from contour.vision.schemas import AppMode, OutputShapeKind, SemPolarity
...
def test_contour_extraction_output_json() -> None:
    from contour.vision.io_normalize import make_image_ref
    from contour.vision.schemas import ContourExtractionOutput, HierarchicalComponent
