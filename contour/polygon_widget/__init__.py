...
_LAZY_EXPORTS = {
    ...
    "PolygonWidgetApplicationComponents": (".application", "PolygonWidgetApplicationComponents"),
    "PolygonWidgetApplicationModel": (".application", "PolygonWidgetApplicationModel"),
    "PolygonWidgetMainView": (".application", "PolygonWidgetMainView"),
    "PolygonWidgetPresenter": (".application", "PolygonWidgetPresenter"),
    "PolygonWidgetStandaloneWindow": (".application", "PolygonWidgetStandaloneWindow"),
