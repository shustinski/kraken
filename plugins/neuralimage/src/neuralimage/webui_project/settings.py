...
ROOT_URLCONF = 'neuralimage.webui_project.urls'
...
WSGI_APPLICATION = 'neuralimage.webui_project.wsgi.application'
ASGI_APPLICATION = 'neuralimage.webui_project.asgi.application'
