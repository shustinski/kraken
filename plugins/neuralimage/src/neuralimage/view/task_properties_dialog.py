...
from neuralimage.application.dto import MainWindowState, SettingsState, clone_main_window_state
from neuralimage.lib.data_interfaces import normalize_multi_gpu_mode, normalize_patch_batch_sync_mode, normalize_work_mode
...
class TaskPropertiesDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        field_texts = get_ui_section('task_properties_fields')
        self._main_form_texts = _as_dict(field_texts.get('main_form'))
        self._settings_form_texts = _as_dict(field_texts.get('settings_form'))
